...
import { accessKeyRouter, accountRouter, backgroundJobsRouter, censusRouter, equipmentsRouter, faqRouter, newsRouter, userRouter } from '../http-routes';
...
v1Router.use("/login", accountRouter());
