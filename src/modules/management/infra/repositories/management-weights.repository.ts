import { DatabaseOperationOutputLogFactory } from "../../../../../modules/logs/core/output";
import { DATABASES } from "../../../../../shared/external/db/tableNames";
import { CultureWeightsMapper } from "../../../entities/mappers/weights";
import { ManagementWeightsRepositoryDTO } from "../../v2/ports/weights/repository";
import { managementDb } from "../../v2/infra/database/connections/db";
