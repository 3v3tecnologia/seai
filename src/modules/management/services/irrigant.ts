...
} from "../../../shared/core/date";
import { DecimalFormatter } from "../../../shared/core/decimal-formatter";
import { BladeSuggestion } from "../core/models/blade-suggestion";
import { ManagementCropCycle } from "../core/models/crop-cycles";
import {
  IrrigationSystemEntity,
  irrigationsTypesNames,
} from "../core/models/irrigation-system";
import {
  Dripping,
  DrippingProps,
  ...
  Sulcos,
  SulcosProps,
} from "../core/models/irrigation-system-measurements";
import { ManagementIrrigantErrors } from "../core/errors/irrigant.error";
import { ManagementCropErrors } from "../core/errors/management-crop-errors";
import { DbEquipmentsMeasurementsRepository } from "../infra/repositories/equipments-measurements.repository";

import { DbManagementCropRepository } from "../infra/repositories/management-crop.repository";
