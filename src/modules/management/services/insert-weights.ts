...
import { CultureWeights } from "../core/models/weights";

import { ManagementWeightsRepositoryProtocol } from "../../census/infra/repositories/protocols/management-weights.repository";
import { GetCulturesIndicatorsFromBasinUseCaseProtocol } from "../../census/services/fetch-cultures-indicators-by-basin";
