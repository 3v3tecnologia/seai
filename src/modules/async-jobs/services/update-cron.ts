...
import { ScheduleRepositoryProtocol } from "../../../domain/use-cases/_ports/repositories/background-jobs-repository";
import { NotExistsError } from "../../../domain/use-cases/errors/notFound-error";
