...
import { JobsRepositoryProtocol } from "../../../domain/use-cases/_ports/repositories/background-jobs-repository";
import { IPaginationInput, IOutputWithPagination, OldOutputWithPagination } from "../../../shared/core/pagination";

import { JobsRepositoryDTO } from '../../../domain/use-cases/_ports/repositories/background-jobs-repository'
