...
import { DbAnimalsCensusRepository } from "../../../../shared/external/db/database/postgres/repositories/animals-census-repository";
import { DbAquacultureCensusRepository } from "../../../../shared/external/db/database/postgres/repositories/aquaculture-census-repository";
import { DbCaptationCensusRepository } from "../../../../shared/external/db/database/postgres/repositories/captation-repository";
import { DbCensusTakersRepository } from "../../../../shared/external/db/database/postgres/repositories/census-takers-census-repository";
import { DbWorkersCensusRepository } from "../../../../shared/external/db/database/postgres/repositories/worker-census-repository";
