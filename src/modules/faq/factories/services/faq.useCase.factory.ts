import {
  ...
  UpdateFaq,
  UpdateFaqCategory,
} from "../../../../modules/faq/services";
import { GetFaqsUseCaseProtocol } from "../../../../modules/faq/services/protocols/fetch-all-faq";
import { FetchFaqByIdProtocol } from "../../../../modules/faq/services/protocols/fetch-faq-by-id";
import { FetchFaqCategoriesProtocol } from "../../../../modules/faq/services/protocols/fetch-faq-categories";
import { DbFaqRepository } from "../../../../shared/external/db/database/postgres/repositories/faq-repository";
